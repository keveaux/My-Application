...
public class BackgroundColorPickerAdapter extends RecyclerView.Adapter<BackgroundColorPickerAdapter.ViewHolder> {
    ...
    BackgroundColorPickerAdapter(@NonNull Context context, @NonNull List<Integer> colorPickerColors) {
        this.context = context;
        this.inflater = LayoutInflater.from(context);
        this.colorPickerColors = colorPickerColors;
    }

    public BackgroundColorPickerAdapter(@NonNull Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.transparent_color_iv.bringToFront();



        holder.colorPickerView.setBackgroundColor(colorPickerColors.get(position));

        if(colorPickerColors.get(position)==ContextCompat.getColor(context, R.color.transparent)){
            holder.transparent_color_iv.setVisibility(View.VISIBLE);
        }else {
            holder.transparent_color_iv.setVisibility(View.GONE);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView transparent_color_iv;

        public ViewHolder(View itemView) {
            super(itemView);
            colorPickerView = itemView.findViewById(R.id.color_picker_view);
            transparent_color_iv=itemView.findViewById(R.id.transparent_color_iv);
    ...
    public static List<Integer> getDefaultColors(Context context) {
        ...
        colorPickerColors.add(ContextCompat.getColor(context, R.color.transparent));
