package com.ict_life.merchantapp.photoeditor.photoeditor.tools;
...
//        mToolList.add(new ToolModel("Brush", R.drawable.ic_brush, ToolType.BRUSH));
        mToolList.add(new ToolModel("Sticker", R.drawable.ic_art, ToolType.STICKER));
...
//        mToolList.add(new ToolModel("Eraser", R.drawable.ic_eraser, ToolType.ERASER));
        mToolList.add(new ToolModel("Filter", R.drawable.ic_filter, ToolType.FILTER));
