package com.ict_life.merchantapp.multipleimagepickerlibrary.adapters;
...
public class ImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static class ViewHolder2 extends RecyclerView.ViewHolder {
        ...
        public ViewHolder2(View v) {
            ...
            indicator =  v.findViewById(R.id.checkmark);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        switch (holder.getItemViewType()) {
            case TYPE_CAMERA:
                ...
                viewHolder1.itemView.setOnClickListener(v -> mImageOnItemClickListener.imageOnItemClick(holder.getAdapterPosition(), null));
                break;
            ...
            case TYPE_NORMAL:
                ...
                if (image != null) {
                    ...
                    if (imageFile.exists()) {
                        Glide.with(mContext).load(Uri.fromFile(new File(image.path))).placeholder(R.drawable.default_error).centerCrop().into(viewHolder2.getImage());
                    } else {
                        viewHolder2.getImage().setImageResource(R.drawable.default_error);
                        Toast.makeText(mContext, "does not exists", Toast.LENGTH_SHORT).show();

                    }
                }
                viewHolder2.itemView.setOnClickListener(v -> mImageOnItemClickListener.imageOnItemClick(holder.getAdapterPosition(), image));
                break;
